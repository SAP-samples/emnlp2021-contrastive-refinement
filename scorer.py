...
def scorer(ans_stats, test_set, output_file=None):
    ...
    elif test_set in ["dpr-test","dpr-dev-small","wscr-test","pdp","winogender","winobias-pro1","winobias-pro2","winobias-anti1","winobias-anti2","winobias-dev","wikicrem-dev", "knowref-test","dpr-test-fold1","dpr-test-fold2","dpr-test-fold3","dpr-test-fold4","dpr-test-fold5"]:
        return compute_accuracy(ans_stats)
    elif test_set in [ "winogrande-test", "wsc", "winogrande-dev"] or test_set.find('winogrande') > -1:
